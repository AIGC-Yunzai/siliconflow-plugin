...
${e.sfRuntime.isgeneratePrompt === undefined ? "tags的额外触发词：\n 自动提示词[开|关]" : ""}`
    ...
    async gg_chat(e, config_date = undefined) {
        ...
        if (usingApiIndex > 0 && config_date.gg_APIList && config_date.gg_APIList[usingApiIndex - 1]) {
            ...
            // 只有当APIList中的字段有值时才使用该值
            ggBaseUrl = apiConfig.apiBaseUrl || config_date.ggBaseUrl || "https://gemini.maliy.top"
            ggKey = this.get_random_key(apiConfig.apiKey) || this.get_random_key(config_date.ggKey) || this.get_random_key(this.ggKeyFreeDecode(config_date.ggKey_free_250822))
            ...
            // 使用默认配置
            ggBaseUrl = config_date.ggBaseUrl || "https://gemini.maliy.top"
            ggKey = this.get_random_key(config_date.ggKey) || this.get_random_key(this.ggKeyFreeDecode(config_date.ggKey_free_250822))

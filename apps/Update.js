...
export class update extends plugin {
  ...
  async sf_Auto_tasker(e = null) {
    ...
    try {
      ...
      const geminiModelsByFetch = await getGeminiModelsByFetch(sf.get_random_key(config_date.ggKey) || sf.get_random_key(sf.ggKeyFreeDecode(config_date.ggKey_free_250705)), config_date.ggBaseUrl || "https://bright-donkey-63.deno.dev");

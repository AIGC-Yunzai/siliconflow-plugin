...
export class update extends plugin {
  ...
  async sf_Auto_tasker(e = null) {
    ...
    try {
      ...
      const geminiModelsByFetch = await getGeminiModelsByFetch(sf.get_random_key(config_date.ggKey) || sf.get_random_key(sf.ggKeyFreeDecode(config_date.ggKey_free_250805)), config_date.ggBaseUrl || "https://gemini.maliya.top");
